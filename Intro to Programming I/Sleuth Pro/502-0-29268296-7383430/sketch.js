...
Officer: 7383430
CaseNum: 502-0-29268296-7383430
...
var paper_A = ["Torvalds", "Judge Hopper", "affair", "Governor Zuckerberg", "Algol Fish Wholesalers"];

var paper_B = ["clean up", "Edsger", "supply of fish", "Cobol Theatre", "Lovelace"];
...
function setup()
{
  ...
  redactedText = "Dear " + paper_A[3] + ", I am writing to you with much confusion and distress. As you know my company " + paper_A[4] + " has been a bastion of the community. Over the years we have provided many jobs for the people of Console City. We’ve kept the city in a good " + paper_B[2] + ". We even paid some tax once. Now I find that our efforts to open a new plant opposite the " + paper_B[3] + " is being blocked by your very own " + paper_A[1] + ". Did I not help you " + paper_B[0] + " the mess after " + paper_A[0] + " ? Did I not keep quiet about your " + paper_A[2] + " with " + paper_B[4] + "? Contact me discreetly and with haste. Some arrangement must be found. Your old friend, " + paper_B[1] + "";
