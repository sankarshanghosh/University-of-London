...
Officer: 7383430
CaseNum: 303-0-77481455-7383430
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make cryptic_safe_valA equal to 44

	Whilst the mouse is being dragged:
	- Make cryptic_safe_valA equal to 12

	When the mouse button is pressed:
	- Make cryptic_safe_valA equal to 38

	Whilst the mouse is moving:
	- Make cryptic_safe_valA equal to 9

	When any key is pressed:
	- Make cryptic_safe_valB equal to 49

	Whilst the mouse is moving:
	- Make cryptic_safe_valB equal to 11

	When the mouse button is pressed:
	- Make cryptic_safe_valB equal to 12

	Whilst the mouse is being dragged:
	- Make cryptic_safe_valB equal to 54
...
var cryptic_safe_valA;
var cryptic_safe_valB;
...
function mouseMoved() {
  ...
  cryptic_safe_valB = 11;
}

function mouseDragged() {
  // Whilst the mouse is being dragged:
  // - Make cryptic_safe_valA equal to 12
  cryptic_safe_valA = 12;
  cryptic_safe_valB = 54;
  console.log("mouseDragged", mouseX, mouseY);
}

function mousePressed() {
  cryptic_safe_valA = 38;
  cryptic_safe_valB = 12;
...
function mouseReleased() {
  // When the mouse button is released:
  // - Make cryptic_safe_valA equal to 44
  cryptic_safe_valA = 44;
  console.log("mousePressed");
}

function keyPressed() {
  cryptic_safe_valB = 49;
...
function draw() {
  ...
  drawDial(200, cryptic_safe_valA, 47);
  pop();

  //Draw the lever
  push();
  translate(width - 125, 256);
  drawLever(cryptic_safe_valB);
  pop();
}
